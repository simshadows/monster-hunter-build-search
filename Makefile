# Clang 10 is the best-performing compiler in my experience on my machine.
CXX2=clang++-10
...
OBJECTS=src/search.o \
		...
		src/database/autogenerated/database_decorations.o \
...
.PHONY : autogen
autogen :
	./src-autogen/autogen_skills_data.py
	./src-autogen/autogen_decorations_data.py
